...
namespace JWT
{
    ...
    public static class JsonWebToken
    {
        ...
        public static string Encode(IDictionary<string, object> extraHeaders, string payload, byte[] key, JwtHashAlgorithm algorithm)
        {
            ...
            byte[] headerBytes = Encoding.UTF8.GetBytes("{\"typ\": \"JWT\", \"alg\": \"HS256\"}");
        ...
        /// <param name="algorithm">The hash algorithm to use.</param>
        /// <returns>The generated JWT.</returns>
        public static string Encode(string payload, byte[] key, JwtHashAlgorithm algorithm)
        {
        ...
        /// <param name="algorithm">The hash algorithm to use.</param>
        /// <returns>The generated JWT.</returns>
        public static string Encode(IDictionary<string, object> extraHeaders, string payload, string key, JwtHashAlgorithm algorithm)
        {
